<?php
    ...
    $to             = 'seda.aydin3@gmail.com'; //put your email here
    $email_template = 'comment.html';  // will find it on email-templates/ directory
    $subject    = "SUBJECT";
    ...
    $templateContents = file_get_contents( dirname(__FILE__) . '/'.$comment.html);
